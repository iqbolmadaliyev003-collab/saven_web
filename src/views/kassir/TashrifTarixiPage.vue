      ...
      <AppCard class="p-5 overflow-visible">
        <div class="mb-4 flex flex-wrap items-center gap-2">
          <div class="relative min-w-[200px] flex-1 group">
            ...
            <input v-model="q" placeholder="Mijoz bo'yicha qidirish" @input="page = 1"
            ...
            <Transition name="dropdown">
              <div v-if="filterOpen"
                ...
                <div class="mb-4 flex gap-2">
                  <button v-for="p in [5, 15, 20, 35]" :key="p" type="button"
          ...
          <table class="w-full text-sm">
            ...
            <TransitionGroup v-else tag="tbody" name="row" appear>
              <tr v-for="(r, i) in paged" :key="r.id"
                ...
                <td class="py-3 text-muted">{{ (page - 1) * pageSize + i + 1 }}</td>
                <td>
